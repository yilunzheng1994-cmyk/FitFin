    ...
    <View className="dashboard">
      ...
      <View className="kpi-grid">
        <View className="kpi-card">
          ...
          <Text className="kpi-value">{formatCurrency(metrics.revenue)}</Text>
        </View>
        <View className="kpi-card">
          <Text className="kpi-label">今日利润</Text>
          <Text className="kpi-value">{formatCurrency(metrics.profit)}</Text>
        </View>
      </View>
      ...
      <View className="kpi-grid">
        <View className="kpi-card">
          ...
          <Text className="kpi-value">{formatCurrency(metrics.totalRevenue)}</Text>
        </View>
        <View className="kpi-card">
          <Text className="kpi-label">累计利润</Text>
          <Text className="kpi-value">{formatCurrency(metrics.totalProfit)}</Text>
        </View>
      </View>
      ...
      <View className="menu-grid">
        <View className={`menu-item ${activeReport === 'pl' ? 'active' : ''}`} onClick={() => setActiveReport('pl')}>
          <Text>📊 利润表</Text>
        </View>
        <View className={`menu-item ${activeReport === 'balance' ? 'active' : ''}`} onClick={() => setActiveReport('balance')}>
          <Text>📋 资产负债表</Text>
        </View>
        <View className={`menu-item ${activeReport === 'cashflow' ? 'active' : ''}`} onClick={() => setActiveReport('cashflow')}>
          <Text>💰 现金流量表</Text>
        </View>
        <View className={`menu-item ${activeReport === 'breakeven' ? 'active' : ''}`} onClick={() => setActiveReport('breakeven')}>
          <Text>⚖️ 盈亏平衡分析</Text>
        </View>
      </View>
